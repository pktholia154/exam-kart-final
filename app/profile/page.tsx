  ...
  return (
    <main className="min-h-screen pt-3 pb-20 max-w-md md:max-w-2xl mx-auto px-2.5 bg-white">
      ...
      <div className="bg-gray-50 rounded-2xl p-4 border border-gray-100 flex items-center gap-3.5 mb-4">
        <div className="w-12 h-12 bg-[#2053BA] rounded-full flex items-center justify-center text-white text-lg font-extrabold shrink-0">
      ...
      <div className="bg-gradient-to-br from-[#8720BA] to-[#2053BA] rounded-2xl p-4 text-white shadow-sm mb-4 relative overflow-hidden">

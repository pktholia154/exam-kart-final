  ...
  return (
    <main className="min-h-screen pt-3 pb-24 max-w-md md:max-w-2xl mx-auto px-2.5 bg-white">
      <div className="flex items-center justify-between pb-3 mb-2 border-b border-gray-100">
        ...
        {purchases.length > 0 && (
          <span className="text-[10px] font-extrabold text-[#3A20BA] bg-[#3A20BA]/10 px-2.5 py-1 rounded-full">
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-16 text-center">
          ...
          <Link href="/" className="px-5 py-2 bg-[#3A20BA] text-white text-xs font-bold rounded-full active:scale-95 transition-transform shadow-sm">
            Explore E-Books
          </Link>
        </div>
      ) : (
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    <Link 
                      ...
                      className="flex-1 bg-[#3A20BA] hover:bg-[#301a9c] text-white py-1.5 px-3 rounded-lg text-[11px] font-bold active:scale-95 transition-transform flex items-center justify-center gap-1 shadow-2xs"
                    >
                    ...
                    >
                      <Download className="w-3 h-3 text-[#3A20BA]" /> Offline
                    </button>
                  </div>
                </div>
              </div>
